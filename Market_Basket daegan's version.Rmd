...
# Extract rule quality
rule_teal_colors <- c(
  "#b2d8d8",  # lift = 1.755556
  "#b2d8d8",  # lift = 1.755556
  "#b2d8d8",  # lift = 1.755556
  "#007a7a",  # lift = 2.972326
  "#99cfcf",  # lift = 1.396515
  "#007c7c",  # lift = 2.918284
  "#8fd1d1",  # lift = 1.370537
  "#85d4d4",  # lift = 1.342189
  "#7bd7d7",  # lift = 1.333718
  "#75d9d9"   # lift = 1.329564
)
