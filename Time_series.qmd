...
p4 <- p1 +
  ...
  geom_line(data = mergedCarriage2DF.pred.its, aes(x = Year, y = pred), group = 1,
            color = "#00356B") +
  # Add the confidence interval.
  geom_ribbon(data = mergedCarriage2DF.pred.its, aes( ymin = conf.low, ymax = conf.high), group = 1, alpha = 0.2, fill = "#008080") +
...
#colors <- c("Negative Binomial Fit" = "#00356B", "Confidence Interval" = "#008080"###,"Counterfactual" = "#E69F00")
...
#                     values = c("Negative Binomial Fitted Line" = "#00356B", "Confidence #Interval" = "#008080","Counterfactual" = "#E69F00"),
#                     labels = c("Negative Binomial Fitted Line", "Confidence Interval", #"Counterfactual"))
```
...
```{r}
ds.pred.mod5$rr.trend<-method3Carriage$CCount/ds.pred.mod5$pred.mod5
```
