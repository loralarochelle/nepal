...
The set of items is $I= \{\mathrm{milk, bread, butter, beer}\}$ and
a small database containing the items 
is shown in Figure~\ref{table:supermarket}.
An example rule for the supermarket could be 
$\{\mathrm{milk, bread}\} \Rightarrow \{\mathrm{butter}\}$ meaning that
...
checking subsets of size 1 2 3 4 5 done [0.78s].
writing ... [80215 rule(s)] done [0.04s].
...
> itemFrequencyPlot(AdultSample[, itemsFrequent], population = Adult[, 
+     itemsFrequent], cex.names = 0.7)
\end{Sinput}
\end{Schunk}
\begin{figure}
\centering
...
> itemsFrequent <- itemFrequency(Adult) > supp
> itemFrequencyPlot(AdultSample[, itemsFrequent], population = Adult[, 
+     itemsFrequent], cex.names = 0.7, deviation = TRUE)
\end{Sinput}
\end{Schunk}
\begin{figure}
\centering
...
\begin{Soutput}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
0.05004 0.05055 0.05118 0.05168 0.05251 0.05647 
...
\begin{Soutput}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
0.05005 0.05049 0.05125 0.05144 0.05212 0.05505 
...
\begin{Soutput}
   Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
 0.8470  0.9582  0.9756  0.9711  0.9886  1.0000 
