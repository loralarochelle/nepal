...
(carriage_plot | disease_plot) +
plot_layout(guides = "collect") +
  plot_annotation(title = "Hierarchical Modeling - Percent of Cases from Each Serotype Group in Each Year",
                  theme = theme(plot.title = element_text(hjust = 0.3, size = 18, face="bold"))) -> PLOT8

ggsave("plot8.png", plot=PLOT8, width=12, height=6)
```
